package com.demo.baseModule.utils;
...
public class DownloadManagerHelper {
    ...
    public void startDownload(String url) {
        ...
        // 删除已经存在的文件
        //FileOpenUtil.deleteFile(filePath);
//        if (new File(filePath).exists() && downloadListener != null) {
//            downloadListener.downLoadSuccess(filePath, tag);
//        }
        // 发送请求
